...
### result_eth_getTransactionReceipt.json 
{
  "name": "Receipt Information",
  "schema": {
    "type": "object",
...
### result_eth_newPendingTransactionFilter.json 
{
  "name": "Filter Identifier",
  "schema": {
    "title": "hex encoded unsigned integer",
...
### result_eth_protocolVersion.json 
{
  "name": "Protocol version",
  "schema": {
    "title": "version",
...
### result_eth_sendRawTransaction.json 
{
  "name": "Transaction hash",
  "schema": {
    "title": "32 byte hex value",
...
### result_eth_sendTransaction.json 
{
  "name": "Transaction hash",
  "schema": {
    "title": "32 byte hex value",
